...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n}\n\n#open-project-form, #open-task-form{\n    margin-left: 3.5rem;\n    margin-top: 2rem;\n    justify-self: center;\n    align-self: center;\n    grid-row-start: 1;\n    grid-row-end: 3;\n\n    padding: 0.6rem;\n    padding-right: 0.7rem;\n\n    font-size: 1rem;\n}\n\n#task-area{\n    padding: 3rem;\n    padding-top: 2.5rem;\n}\n\n.task-title{\n    font-size: 1.1em;\n    margin: 0.6em;\n}\n\n#task-list{\n    display: grid;\n    gap: 10px;\n}\n\n\n#open-task-form{\n    margin-left: 0;\n    margin-top: 15px;\n    margin-bottom: 20px;\n}\n\n.delete-task{\n    align-self: center;\n    justify-self: center;\n    height: 1.4rem;\n    width: 1.4rem;\n    border-radius: 30%;\n    display: none;\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    padding: 0;\n    margin: 0;\n}\n\n.task-header:hover .delete-task{\n    display: block;\n}\n\n.delete-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n\n/* The Modal (background) */\n.modal {\n    display: none; /* Hidden by default */\n    position: fixed; /* Stay in place */\n    z-index: 1; /* Sit on top */\n    padding-top: 150px; /* Location of the box */\n    left: 0;\n    top: 0;\n    width: 100%; /* Full width */\n    height: 100%; /* Full height */\n    overflow: auto; /* Enable scroll if needed */\n    background-color: rgb(0,0,0); /* Fallback color */\n    background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n  }\n  \n  /* Modal Content */\n  .modal-content {\n    background-color: #fefefe;\n    margin: auto;\n    padding: 20px;\n    padding-bottom: 30px;\n    border: 1px solid #888;\n    border-radius: 3.5px;\n    width: 50%;\n\n    display: grid;\n  }\n  \n  /* The Close Button */\n  .close {\n    color: #aaaaaa;\n    float: right;\n    font-size: 28px;\n    font-weight: bold;\n    justify-self: right;\n  }\n  \n  .close:hover,\n  .close:focus {\n    color: #000;\n    text-decoration: none;\n    cursor: pointer;\n  }\n\n  #curr-project-title{\n      margin-top: 2rem;\n      margin-bottom: 20px;\n      font-size: 1.8rem;\n      padding-bottom: 0.25rem;\n\n      cursor: default;\n\n      -webkit-user-select: none; /* Safari */        \n      -moz-user-select: none; /* Firefox */\n      -ms-user-select: none; /* IE10+/Edge */\n      user-select: none; /* Standard */\n  }\n\n  .task-details, .task-title{\n      margin-left: 15px;\n  }\n\n  .task-details{\n      border: solid var(--task-header) 1px;\n      border-top: none;\n      border-radius: 0px 0px 3px 3px;\n\n      margin: 0;\n      padding: 0;\n      margin-right: 10%;\n\n      padding-left: 0.8rem;\n      padding-top: 0.4rem;\n      padding-bottom: 0.4rem;\n\n  }\n\n  .task-description, .task-priority{\n    margin: 0.65em;\n }\n .task-description{\n     font-style: italic;\n }\n\n  .due-date{\n      align-self: center;\n      justify-self: right;\n      padding-right: 1rem;\n      font-size: 0.85rem;\n  }\n\n  .task-header{\n      background-color: var(--task-header);\n      margin: 0;\n      padding: 0;\n      border-radius: 3px;\n\n      display: grid;\n      grid-template-columns: 68% 26% 3% 3%;\n      margin-right: 10%;\n\n      cursor: pointer;\n  }\n\n  .task-header{\n    grid-template-columns: 74% 26%;\n  }\n\n  .task-header:hover{\n    grid-template-columns: 66% 26% 4% 4%;\n  }\n\n  .task-header:hover{\n      background-color: var(--task-header-hover);\n  }\n\n  .overdue{\n      color: red;\n  }\n\n  #add-task-header{\n      text-align: center;\n  }\n\n  .user-input{\n      margin: 1rem;\n      margin-top: 1.3rem;\n  }\n\n  #priority{\n      width: 85%;\n  }\n\n  .edit-task{\n    display: none;\n    align-self: center;\n    justify-self: center;\n    height: 1.8rem;\n    background-color: transparent;\n    border: none;\n}\n\n.task-header:hover .edit-task{\n    display: block;\n}\n\n.edit-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n  \n  #low, #medium, #high{\n      margin-left: 1.4rem;\n      margin-right: 0.5rem;\n  }\n\n  #newTask-dueDate, #newTask-description, #task-title, #add-task{\n      margin-left: 15px;\n      height: 2em;\n      padding-left: 0.4rem;\n      padding-right: 0.4rem;\n      width: 40%;\n  }\n\n  fieldset{\n      border: solid 1px black;\n      border-radius: 3px;\n      padding: 0.8rem;\n  }\n\n  #add-task{\n    width: 105px;\n    height: 40px;\n    \n    margin-top: 10px;\n\n    align-self: center;\n    justify-self: center;\n  }\n\n  #newTask-dueDate{\n      width: 8.11rem;\n  }\n\n  .high{\n    border-left: red solid 4px;\n  }\n\n  .medium{\n    border-left: yellow solid 4px;\n  }\n\n  .low{\n      border-left: green solid 4px;\n  }\n\n  .task{\n      cursor: default;\n  }\n\n\n label{\n     font-size: 0.9em;\n }\n\n .form-error{\n     font-size: 0.7em;\n     color: red;\n }\n\n\n\n", "",{"version":3,"sources":["webpack://./src/css/task-style.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;IACrB,wBAAwB;IACxB,0BAA0B;IAC1B,uBAAuB;IACvB,oBAAoB;IACpB,sBAAsB;IACtB,4BAA4B;AAChC;;AAEA;IACI,mBAAmB;IACnB,gBAAgB;IAChB,oBAAoB;IACpB,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;;IAEf,eAAe;IACf,qBAAqB;;IAErB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,SAAS;AACb;;;AAGA;IACI,cAAc;IACd,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,oBAAoB;IACpB,cAAc;IACd,aAAa;IACb,kBAAkB;IAClB,aAAa;IACb,6BAA6B;IAC7B,YAAY;IACZ,eAAe;IACf,UAAU;IACV,SAAS;AACb;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kCAAkC;IAClC,YAAY;AAChB;;;AAGA,2BAA2B;AAC3B;IACI,aAAa,EAAE,sBAAsB;IACrC,eAAe,EAAE,kBAAkB;IACnC,UAAU,EAAE,eAAe;IAC3B,kBAAkB,EAAE,wBAAwB;IAC5C,OAAO;IACP,MAAM;IACN,WAAW,EAAE,eAAe;IAC5B,YAAY,EAAE,gBAAgB;IAC9B,cAAc,EAAE,4BAA4B;IAC5C,4BAA4B,EAAE,mBAAmB;IACjD,iCAAiC,EAAE,qBAAqB;EAC1D;;EAEA,kBAAkB;EAClB;IACE,yBAAyB;IACzB,YAAY;IACZ,aAAa;IACb,oBAAoB;IACpB,sBAAsB;IACtB,oBAAoB;IACpB,UAAU;;IAEV,aAAa;EACf;;EAEA,qBAAqB;EACrB;IACE,cAAc;IACd,YAAY;IACZ,eAAe;IACf,iBAAiB;IACjB,mBAAmB;EACrB;;EAEA;;IAEE,WAAW;IACX,qBAAqB;IACrB,eAAe;EACjB;;EAEA;MACI,gBAAgB;MAChB,mBAAmB;MACnB,iBAAiB;MACjB,uBAAuB;;MAEvB,eAAe;;MAEf,yBAAyB,EAAE,WAAW;MACtC,sBAAsB,EAAE,YAAY;MACpC,qBAAqB,EAAE,eAAe;MACtC,iBAAiB,EAAE,aAAa;EACpC;;EAEA;MACI,iBAAiB;EACrB;;EAEA;MACI,oCAAoC;MACpC,gBAAgB;MAChB,8BAA8B;;MAE9B,SAAS;MACT,UAAU;MACV,iBAAiB;;MAEjB,oBAAoB;MACpB,mBAAmB;MACnB,sBAAsB;;EAE1B;;EAEA;IACE,cAAc;CACjB;CACA;KACI,kBAAkB;CACtB;;EAEC;MACI,kBAAkB;MAClB,mBAAmB;MACnB,mBAAmB;MACnB,kBAAkB;EACtB;;EAEA;MACI,oCAAoC;MACpC,SAAS;MACT,UAAU;MACV,kBAAkB;;MAElB,aAAa;MACb,oCAAoC;MACpC,iBAAiB;;MAEjB,eAAe;EACnB;;EAEA;IACE,8BAA8B;EAChC;;EAEA;IACE,oCAAoC;EACtC;;EAEA;MACI,0CAA0C;EAC9C;;EAEA;MACI,UAAU;EACd;;EAEA;MACI,kBAAkB;EACtB;;EAEA;MACI,YAAY;MACZ,kBAAkB;EACtB;;EAEA;MACI,UAAU;EACd;;EAEA;IACE,aAAa;IACb,kBAAkB;IAClB,oBAAoB;IACpB,cAAc;IACd,6BAA6B;IAC7B,YAAY;AAChB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kCAAkC;IAClC,YAAY;AAChB;;;EAGE;MACI,mBAAmB;MACnB,oBAAoB;EACxB;;EAEA;MACI,iBAAiB;MACjB,WAAW;MACX,oBAAoB;MACpB,qBAAqB;MACrB,UAAU;EACd;;EAEA;MACI,uBAAuB;MACvB,kBAAkB;MAClB,eAAe;EACnB;;EAEA;IACE,YAAY;IACZ,YAAY;;IAEZ,gBAAgB;;IAEhB,kBAAkB;IAClB,oBAAoB;EACtB;;EAEA;MACI,cAAc;EAClB;;EAEA;IACE,0BAA0B;EAC5B;;EAEA;IACE,6BAA6B;EAC/B;;EAEA;MACI,4BAA4B;EAChC;;EAEA;MACI,eAAe;EACnB;;;CAGD;KACI,gBAAgB;CACpB;;CAEA;KACI,gBAAgB;KAChB,UAAU;CACd","sourcesContent":[":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n}\n\n#open-project-form, #open-task-form{\n    margin-left: 3.5rem;\n    margin-top: 2rem;\n    justify-self: center;\n    align-self: center;\n    grid-row-start: 1;\n    grid-row-end: 3;\n\n    padding: 0.6rem;\n    padding-right: 0.7rem;\n\n    font-size: 1rem;\n}\n\n#task-area{\n    padding: 3rem;\n    padding-top: 2.5rem;\n}\n\n.task-title{\n    font-size: 1.1em;\n    margin: 0.6em;\n}\n\n#task-list{\n    display: grid;\n    gap: 10px;\n}\n\n\n#open-task-form{\n    margin-left: 0;\n    margin-top: 15px;\n    margin-bottom: 20px;\n}\n\n.delete-task{\n    align-self: center;\n    justify-self: center;\n    height: 1.4rem;\n    width: 1.4rem;\n    border-radius: 30%;\n    display: none;\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    padding: 0;\n    margin: 0;\n}\n\n.task-header:hover .delete-task{\n    display: block;\n}\n\n.delete-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n\n/* The Modal (background) */\n.modal {\n    display: none; /* Hidden by default */\n    position: fixed; /* Stay in place */\n    z-index: 1; /* Sit on top */\n    padding-top: 150px; /* Location of the box */\n    left: 0;\n    top: 0;\n    width: 100%; /* Full width */\n    height: 100%; /* Full height */\n    overflow: auto; /* Enable scroll if needed */\n    background-color: rgb(0,0,0); /* Fallback color */\n    background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n  }\n  \n  /* Modal Content */\n  .modal-content {\n    background-color: #fefefe;\n    margin: auto;\n    padding: 20px;\n    padding-bottom: 30px;\n    border: 1px solid #888;\n    border-radius: 3.5px;\n    width: 50%;\n\n    display: grid;\n  }\n  \n  /* The Close Button */\n  .close {\n    color: #aaaaaa;\n    float: right;\n    font-size: 28px;\n    font-weight: bold;\n    justify-self: right;\n  }\n  \n  .close:hover,\n  .close:focus {\n    color: #000;\n    text-decoration: none;\n    cursor: pointer;\n  }\n\n  #curr-project-title{\n      margin-top: 2rem;\n      margin-bottom: 20px;\n      font-size: 1.8rem;\n      padding-bottom: 0.25rem;\n\n      cursor: default;\n\n      -webkit-user-select: none; /* Safari */        \n      -moz-user-select: none; /* Firefox */\n      -ms-user-select: none; /* IE10+/Edge */\n      user-select: none; /* Standard */\n  }\n\n  .task-details, .task-title{\n      margin-left: 15px;\n  }\n\n  .task-details{\n      border: solid var(--task-header) 1px;\n      border-top: none;\n      border-radius: 0px 0px 3px 3px;\n\n      margin: 0;\n      padding: 0;\n      margin-right: 10%;\n\n      padding-left: 0.8rem;\n      padding-top: 0.4rem;\n      padding-bottom: 0.4rem;\n\n  }\n\n  .task-description, .task-priority{\n    margin: 0.65em;\n }\n .task-description{\n     font-style: italic;\n }\n\n  .due-date{\n      align-self: center;\n      justify-self: right;\n      padding-right: 1rem;\n      font-size: 0.85rem;\n  }\n\n  .task-header{\n      background-color: var(--task-header);\n      margin: 0;\n      padding: 0;\n      border-radius: 3px;\n\n      display: grid;\n      grid-template-columns: 68% 26% 3% 3%;\n      margin-right: 10%;\n\n      cursor: pointer;\n  }\n\n  .task-header{\n    grid-template-columns: 74% 26%;\n  }\n\n  .task-header:hover{\n    grid-template-columns: 66% 26% 4% 4%;\n  }\n\n  .task-header:hover{\n      background-color: var(--task-header-hover);\n  }\n\n  .overdue{\n      color: red;\n  }\n\n  #add-task-header{\n      text-align: center;\n  }\n\n  .user-input{\n      margin: 1rem;\n      margin-top: 1.3rem;\n  }\n\n  #priority{\n      width: 85%;\n  }\n\n  .edit-task{\n    display: none;\n    align-self: center;\n    justify-self: center;\n    height: 1.8rem;\n    background-color: transparent;\n    border: none;\n}\n\n.task-header:hover .edit-task{\n    display: block;\n}\n\n.edit-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n  \n  #low, #medium, #high{\n      margin-left: 1.4rem;\n      margin-right: 0.5rem;\n  }\n\n  #newTask-dueDate, #newTask-description, #task-title, #add-task{\n      margin-left: 15px;\n      height: 2em;\n      padding-left: 0.4rem;\n      padding-right: 0.4rem;\n      width: 40%;\n  }\n\n  fieldset{\n      border: solid 1px black;\n      border-radius: 3px;\n      padding: 0.8rem;\n  }\n\n  #add-task{\n    width: 105px;\n    height: 40px;\n    \n    margin-top: 10px;\n\n    align-self: center;\n    justify-self: center;\n  }\n\n  #newTask-dueDate{\n      width: 8.11rem;\n  }\n\n  .high{\n    border-left: red solid 4px;\n  }\n\n  .medium{\n    border-left: yellow solid 4px;\n  }\n\n  .low{\n      border-left: green solid 4px;\n  }\n\n  .task{\n      cursor: default;\n  }\n\n\n label{\n     font-size: 0.9em;\n }\n\n .form-error{\n     font-size: 0.7em;\n     color: red;\n }\n\n\n\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
class DisplayTask {
    ...
    static displayDate(dueDate) {
        ...
        try {
            formattedDate = `due ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(dueDate), 'MM-dd-yyyy')}`

...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n    --background: #e69c7571;\n    --salmon: #f28482;\n    --pinky: #eeacab;\n}\n\nbody{\n    margin: 0;\n    font-family: Arial, sans-serif;\n    background-color: white;\n    color: #333;\n}\n\n.site-container{\n    display: grid;\n    /* grid-template-rows: 90px 745px; */\n    grid-template-rows: 90px 89.5vh;\n}\n\n.class-container{\n    display: grid;\n    grid-template-rows: repeat(3, auto);\n}\n\n#header{\n    align-self: center;\n    background-color: var(--salmon);\n    color: white;\n    padding: 5px;\n    padding-left: 2rem;\n    padding-top: 1rem;\n\n    box-shadow: 1px 0.5px 5px rgb(155, 155, 155);\n    position: relative;\n    z-index: 2;\n}\n\n.logo{\n    font-family: 'Bungee Shade', cursive;\n    font-size: 2.3rem;\n    cursor: default;\n}\n\n.display-container{\n    display: grid;\n    grid-template-columns: 17rem auto;\n    gap: 4%;\n}\n\n.add, #project-form button{\n    background-color: rgb(230, 163, 82);\n    background: radial-gradient(circle,rgba(157, 75, 211, 0.7) 20%,  rgba(167, 96, 214, 0.7)100%);\n    border: none;\n    color: white;\n}\n\n.add:hover, #project-form button:hover{\n    background: radial-gradient(circle,rgba(131,58,180, .55) 20%,  rgba(146, 89, 184, 0.55)100%);\n    color: white;\n}\n\n.active, .project:hover{\n    background: linear-gradient(90deg, rgba(131,58,180, 0.6) 0%, rgba(253,29,29, 0.6) 50%, rgba(252,176,69, 0.6) 100%);\n    color: white;\n}\n\n.project:hover .delete-project{\n    display: block;\n    cursor: pointer;\n}\n\n.project{\n    border-radius: 7px;\n    align-content: center;\n    margin-left: 0.8rem;\n\n    display: grid;\n    grid-template-columns: 10.5rem 1rem;\n    grid-gap: 0.5em;\n\n    cursor: pointer;\n    width: 95%;\n}\n\n#project-area{\n    background-color: var(--pinky);\n    padding: 1rem;\n    padding-right: 0.6em;\n}\n\n.project-title{\n    padding-left: 1.2em;\n    word-wrap: normal;\n    font-size: 0.95rem;\n}\n\n.project-category{\n    font-size: 1.15rem;\n    margin-left: 1.1em;\n    cursor: default;\n}\n\n#project-list{\n    overflow-y: scroll;\n    overflow-x: hidden;\n    margin: 0;\n    padding: 0;\n    max-height: 50vh;\n    max-width: 700px;\n\n    box-shadow: inset -10px -10px 10px 30px var(--pinky);\n    position: relative;\n    z-index: 1;\n}\n\n.delete-project{\n    display: none;\n    align-self: center;\n    justify-self: left;\n    height: 1.5rem;\n    width: 1.5rem;\n    border-radius: 50%;\n    background-color: transparent;\n    color: white;\n    border: none;\n}\n\n.delete-project:hover{\n    background-color: white;\n    color: rgba(252,176,69,1);\n    border: none;\n}\n\n.project-form-container{\n    display: grid;\n    grid-template-columns: 50% 50%;\n    grid-template-rows: auto auto;\n    grid-template-areas: \n        'input input'\n        'error error'\n        'add cancel'\n}\n\n.hidden{\n    display: none;\n}\n\n#project-title{\n    grid-area: input;\n\n    width: 75%;\n    align-self: center;\n    justify-self: center;\n\n    padding: 0.2rem;\n    \n    margin-top: 0.5rem;\n    margin-bottom: 0rem;\n    height: 1.5rem;\n}\n\n.logo, .project-category{\n    -webkit-user-select: none; /* Safari */        \n    -moz-user-select: none; /* Firefox */\n    -ms-user-select: none; /* IE10+/Edge */\n    user-select: none; /* Standard */\n}\n\nh3{\n    font-weight: normal;\n}\n\n#project-form input{\n    border-radius: 4px;\n    border: 2px solid #f0f0f0;\n    font-family: inherit;\n    font-size: 0.9em;\n    padding: 0.4em;\n    width: 90%;\n}\n\n#project-form input:focus{\n    outline: 0;\n    border-color: #777;\n}\n\nbutton{\n    border-radius: 4px;\n    cursor: grab;\n}\n\n#project-form button{\n    border-radius: 4px;\n    width: 90%;\n    padding: 0.75em;\n    margin-left: 5px;\n    margin-right: 5px;\n    color: white;\n    font-size: 0.9em;\n}\n\n#add-project{\n    justify-self: right;\n}\n\n#project-form small{\n    grid-area: error;\n    margin-bottom: 0.5rem;\n    margin-left: 5px;\n    margin-top: 0.2em;\n    padding: 0.2em;\n    visibility: hidden;\n    color: red;\n}\n\n#project-form.error small{\n    visibility: visible;\n}\n\n#project-form.success input{\n    border-color: #2ecc71;\n}\n\n#welcome{\n    display: grid;\n    grid-template-rows: 10% 30%;\n    padding: 3rem;\n    padding-top: 10rem;\n}\n\n#welcome h2{\n    font-size: 2rem;\n    align-self: center;\n    justify-self: center;\n}\n\n #welcome p{\n    margin-left: 20%;\n    margin-right: 20%;\n    font-size: 1.25rem;\n }", "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;IACrB,wBAAwB;IACxB,0BAA0B;IAC1B,uBAAuB;IACvB,oBAAoB;IACpB,sBAAsB;IACtB,4BAA4B;IAC5B,uBAAuB;IACvB,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,SAAS;IACT,8BAA8B;IAC9B,uBAAuB;IACvB,WAAW;AACf;;AAEA;IACI,aAAa;IACb,oCAAoC;IACpC,+BAA+B;AACnC;;AAEA;IACI,aAAa;IACb,mCAAmC;AACvC;;AAEA;IACI,kBAAkB;IAClB,+BAA+B;IAC/B,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;;IAEjB,4CAA4C;IAC5C,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,oCAAoC;IACpC,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,iCAAiC;IACjC,OAAO;AACX;;AAEA;IACI,mCAAmC;IACnC,6FAA6F;IAC7F,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,4FAA4F;IAC5F,YAAY;AAChB;;AAEA;IACI,kHAAkH;IAClH,YAAY;AAChB;;AAEA;IACI,cAAc;IACd,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,qBAAqB;IACrB,mBAAmB;;IAEnB,aAAa;IACb,mCAAmC;IACnC,eAAe;;IAEf,eAAe;IACf,UAAU;AACd;;AAEA;IACI,8BAA8B;IAC9B,aAAa;IACb,oBAAoB;AACxB;;AAEA;IACI,mBAAmB;IACnB,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,SAAS;IACT,UAAU;IACV,gBAAgB;IAChB,gBAAgB;;IAEhB,oDAAoD;IACpD,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,aAAa;IACb,kBAAkB;IAClB,kBAAkB;IAClB,cAAc;IACd,aAAa;IACb,kBAAkB;IAClB,6BAA6B;IAC7B,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,uBAAuB;IACvB,yBAAyB;IACzB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,6BAA6B;IAC7B;;;;AAIJ;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,gBAAgB;;IAEhB,UAAU;IACV,kBAAkB;IAClB,oBAAoB;;IAEpB,eAAe;;IAEf,kBAAkB;IAClB,mBAAmB;IACnB,cAAc;AAClB;;AAEA;IACI,yBAAyB,EAAE,WAAW;IACtC,sBAAsB,EAAE,YAAY;IACpC,qBAAqB,EAAE,eAAe;IACtC,iBAAiB,EAAE,aAAa;AACpC;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,yBAAyB;IACzB,oBAAoB;IACpB,gBAAgB;IAChB,cAAc;IACd,UAAU;AACd;;AAEA;IACI,UAAU;IACV,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,eAAe;IACf,gBAAgB;IAChB,iBAAiB;IACjB,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;IAChB,qBAAqB;IACrB,gBAAgB;IAChB,iBAAiB;IACjB,cAAc;IACd,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,2BAA2B;IAC3B,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,oBAAoB;AACxB;;CAEC;IACG,gBAAgB;IAChB,iBAAiB;IACjB,kBAAkB;CACrB","sourcesContent":[":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n    --background: #e69c7571;\n    --salmon: #f28482;\n    --pinky: #eeacab;\n}\n\nbody{\n    margin: 0;\n    font-family: Arial, sans-serif;\n    background-color: white;\n    color: #333;\n}\n\n.site-container{\n    display: grid;\n    /* grid-template-rows: 90px 745px; */\n    grid-template-rows: 90px 89.5vh;\n}\n\n.class-container{\n    display: grid;\n    grid-template-rows: repeat(3, auto);\n}\n\n#header{\n    align-self: center;\n    background-color: var(--salmon);\n    color: white;\n    padding: 5px;\n    padding-left: 2rem;\n    padding-top: 1rem;\n\n    box-shadow: 1px 0.5px 5px rgb(155, 155, 155);\n    position: relative;\n    z-index: 2;\n}\n\n.logo{\n    font-family: 'Bungee Shade', cursive;\n    font-size: 2.3rem;\n    cursor: default;\n}\n\n.display-container{\n    display: grid;\n    grid-template-columns: 17rem auto;\n    gap: 4%;\n}\n\n.add, #project-form button{\n    background-color: rgb(230, 163, 82);\n    background: radial-gradient(circle,rgba(157, 75, 211, 0.7) 20%,  rgba(167, 96, 214, 0.7)100%);\n    border: none;\n    color: white;\n}\n\n.add:hover, #project-form button:hover{\n    background: radial-gradient(circle,rgba(131,58,180, .55) 20%,  rgba(146, 89, 184, 0.55)100%);\n    color: white;\n}\n\n.active, .project:hover{\n    background: linear-gradient(90deg, rgba(131,58,180, 0.6) 0%, rgba(253,29,29, 0.6) 50%, rgba(252,176,69, 0.6) 100%);\n    color: white;\n}\n\n.project:hover .delete-project{\n    display: block;\n    cursor: pointer;\n}\n\n.project{\n    border-radius: 7px;\n    align-content: center;\n    margin-left: 0.8rem;\n\n    display: grid;\n    grid-template-columns: 10.5rem 1rem;\n    grid-gap: 0.5em;\n\n    cursor: pointer;\n    width: 95%;\n}\n\n#project-area{\n    background-color: var(--pinky);\n    padding: 1rem;\n    padding-right: 0.6em;\n}\n\n.project-title{\n    padding-left: 1.2em;\n    word-wrap: normal;\n    font-size: 0.95rem;\n}\n\n.project-category{\n    font-size: 1.15rem;\n    margin-left: 1.1em;\n    cursor: default;\n}\n\n#project-list{\n    overflow-y: scroll;\n    overflow-x: hidden;\n    margin: 0;\n    padding: 0;\n    max-height: 50vh;\n    max-width: 700px;\n\n    box-shadow: inset -10px -10px 10px 30px var(--pinky);\n    position: relative;\n    z-index: 1;\n}\n\n.delete-project{\n    display: none;\n    align-self: center;\n    justify-self: left;\n    height: 1.5rem;\n    width: 1.5rem;\n    border-radius: 50%;\n    background-color: transparent;\n    color: white;\n    border: none;\n}\n\n.delete-project:hover{\n    background-color: white;\n    color: rgba(252,176,69,1);\n    border: none;\n}\n\n.project-form-container{\n    display: grid;\n    grid-template-columns: 50% 50%;\n    grid-template-rows: auto auto;\n    grid-template-areas: \n        'input input'\n        'error error'\n        'add cancel'\n}\n\n.hidden{\n    display: none;\n}\n\n#project-title{\n    grid-area: input;\n\n    width: 75%;\n    align-self: center;\n    justify-self: center;\n\n    padding: 0.2rem;\n    \n    margin-top: 0.5rem;\n    margin-bottom: 0rem;\n    height: 1.5rem;\n}\n\n.logo, .project-category{\n    -webkit-user-select: none; /* Safari */        \n    -moz-user-select: none; /* Firefox */\n    -ms-user-select: none; /* IE10+/Edge */\n    user-select: none; /* Standard */\n}\n\nh3{\n    font-weight: normal;\n}\n\n#project-form input{\n    border-radius: 4px;\n    border: 2px solid #f0f0f0;\n    font-family: inherit;\n    font-size: 0.9em;\n    padding: 0.4em;\n    width: 90%;\n}\n\n#project-form input:focus{\n    outline: 0;\n    border-color: #777;\n}\n\nbutton{\n    border-radius: 4px;\n    cursor: grab;\n}\n\n#project-form button{\n    border-radius: 4px;\n    width: 90%;\n    padding: 0.75em;\n    margin-left: 5px;\n    margin-right: 5px;\n    color: white;\n    font-size: 0.9em;\n}\n\n#add-project{\n    justify-self: right;\n}\n\n#project-form small{\n    grid-area: error;\n    margin-bottom: 0.5rem;\n    margin-left: 5px;\n    margin-top: 0.2em;\n    padding: 0.2em;\n    visibility: hidden;\n    color: red;\n}\n\n#project-form.error small{\n    visibility: visible;\n}\n\n#project-form.success input{\n    border-color: #2ecc71;\n}\n\n#welcome{\n    display: grid;\n    grid-template-rows: 10% 30%;\n    padding: 3rem;\n    padding-top: 10rem;\n}\n\n#welcome h2{\n    font-size: 2rem;\n    align-self: center;\n    justify-self: center;\n}\n\n #welcome p{\n    margin-left: 20%;\n    margin-right: 20%;\n    font-size: 1.25rem;\n }"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n}\n\n#open-project-form, #open-task-form{\n    margin-left: .6rem;\n    margin-top: 2rem;\n    justify-self: center;\n    align-self: center;\n    grid-row-start: 1;\n    grid-row-end: 3;\n    padding: 0.6rem;\n    padding-right: 0.7rem;\n    font-size: 1rem;\n    width: 90%;\n}\n\n#task-area{\n    padding: 3rem;\n    padding-top: 2.5rem;\n}\n\n.task-title{\n    font-size: 1.1em;\n    margin: 0.6em;\n}\n\n#task-list{\n    display: grid;\n    gap: 10px;\n}\n\n\n#open-task-form{\n    margin-left: 0;\n    margin-top: 15px;\n    margin-bottom: 20px;\n}\n\n.delete-task{\n    align-self: center;\n    justify-self: center;\n    height: 1.4rem;\n    width: 1.4rem;\n    border-radius: 30%;\n    display: none;\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    padding: 0;\n    margin: 0;\n}\n\n.task-header:hover .delete-task{\n    display: block;\n}\n\n.delete-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n\n#curr-project-title{\n    margin-top: 2rem;\n    margin-bottom: 20px;\n    font-size: 1.8rem;\n    padding-bottom: 0.25rem;\n\n    cursor: default;\n\n    -webkit-user-select: none; /* Safari */        \n    -moz-user-select: none; /* Firefox */\n    -ms-user-select: none; /* IE10+/Edge */\n    user-select: none; /* Standard */\n}\n\n.task-details, .task-title{\n    margin-left: 4px;\n}\n\n.task-details{\n    border: solid var(--task-header) 1px;\n    border-top: none;\n    border-radius: 0px 0px 3px 3px;\n\n    margin: 0;\n    padding: 0;\n    margin-right: 10%;\n\n    padding-left: 0.8rem;\n    padding-top: 0.4rem;\n    padding-bottom: 0.4rem;\n\n}\n\n.task-description, .task-priority{\nmargin: 0.65em;\n}\n.task-description{\n    font-style: italic;\n}\n\n.due-date{\n    align-self: center;\n    justify-self: right;\n    padding-right: 1rem;\n    font-size: 0.85rem;\n}\n\n.task-header{\n    background-color: var(--task-header);\n    margin: 0;\n    padding: 0;\n    border-radius: 3px;\n\n    display: grid;\n    grid-template-columns: 4% 70% 26%;\n    margin-right: 10%;\n\n    cursor: pointer;\n    border-left: solid transparent 4px;\n}\n\n.task-header:hover{\n    grid-template-columns: 4% 62% 26% 4% 4%;\n}\n\n.task-header:hover{\n    background-color: var(--task-header-hover);\n}\n\n.overdue{\n    color: red;\n}\n\n#add-task-header{\n    text-align: center;\n}\n\n.edit-task{\n    display: none;\n    align-self: center;\n    justify-self: center;\n    height: 1.8rem;\n    background-color: transparent;\n    border: none;\n}\n\n.task-header:hover .edit-task{\n    display: block;\n}\n\n.edit-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n.high{\n    border-left: red solid 4px;\n}\n\n.medium{\n    border-left: yellow solid 4px;\n}\n\n.low{\n    border-left: green solid 4px;\n}\n\n.task{\n    cursor: default;\n}\n\n\n.task-header .far{\n    justify-self: center;\n    align-self: center;\n}\n\n.hidden{\n    display: none;\n}\n\n.fa-check-circle.hidden .fa-circle{\n    color: red;\n}\n\n.crossed-out{\n    text-decoration: line-through;\n}", "",{"version":3,"sources":["webpack://./src/css/task-style.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;IACrB,wBAAwB;IACxB,0BAA0B;IAC1B,uBAAuB;IACvB,oBAAoB;IACpB,sBAAsB;IACtB,4BAA4B;AAChC;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,oBAAoB;IACpB,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;IACf,eAAe;IACf,qBAAqB;IACrB,eAAe;IACf,UAAU;AACd;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,SAAS;AACb;;;AAGA;IACI,cAAc;IACd,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,oBAAoB;IACpB,cAAc;IACd,aAAa;IACb,kBAAkB;IAClB,aAAa;IACb,6BAA6B;IAC7B,YAAY;IACZ,eAAe;IACf,UAAU;IACV,SAAS;AACb;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kCAAkC;IAClC,YAAY;AAChB;;;AAGA;IACI,gBAAgB;IAChB,mBAAmB;IACnB,iBAAiB;IACjB,uBAAuB;;IAEvB,eAAe;;IAEf,yBAAyB,EAAE,WAAW;IACtC,sBAAsB,EAAE,YAAY;IACpC,qBAAqB,EAAE,eAAe;IACtC,iBAAiB,EAAE,aAAa;AACpC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,oCAAoC;IACpC,gBAAgB;IAChB,8BAA8B;;IAE9B,SAAS;IACT,UAAU;IACV,iBAAiB;;IAEjB,oBAAoB;IACpB,mBAAmB;IACnB,sBAAsB;;AAE1B;;AAEA;AACA,cAAc;AACd;AACA;IACI,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;IACnB,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,oCAAoC;IACpC,SAAS;IACT,UAAU;IACV,kBAAkB;;IAElB,aAAa;IACb,iCAAiC;IACjC,iBAAiB;;IAEjB,eAAe;IACf,kCAAkC;AACtC;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,0CAA0C;AAC9C;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,kBAAkB;IAClB,oBAAoB;IACpB,cAAc;IACd,6BAA6B;IAC7B,YAAY;AAChB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kCAAkC;IAClC,YAAY;AAChB;;AAEA;IACI,0BAA0B;AAC9B;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,eAAe;AACnB;;;AAGA;IACI,oBAAoB;IACpB,kBAAkB;AACtB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,6BAA6B;AACjC","sourcesContent":[":root{\n    --dark-green: #002500;\n    --russian-green: #6A8D73;\n    --blanched-almond: #f0efeb;\n    --mydarkpurple: #5D576B;\n    --my-purple: #807891;\n    --task-header: #f0efeb;\n    --task-header-hover: #f8f8f6;\n}\n\n#open-project-form, #open-task-form{\n    margin-left: .6rem;\n    margin-top: 2rem;\n    justify-self: center;\n    align-self: center;\n    grid-row-start: 1;\n    grid-row-end: 3;\n    padding: 0.6rem;\n    padding-right: 0.7rem;\n    font-size: 1rem;\n    width: 90%;\n}\n\n#task-area{\n    padding: 3rem;\n    padding-top: 2.5rem;\n}\n\n.task-title{\n    font-size: 1.1em;\n    margin: 0.6em;\n}\n\n#task-list{\n    display: grid;\n    gap: 10px;\n}\n\n\n#open-task-form{\n    margin-left: 0;\n    margin-top: 15px;\n    margin-bottom: 20px;\n}\n\n.delete-task{\n    align-self: center;\n    justify-self: center;\n    height: 1.4rem;\n    width: 1.4rem;\n    border-radius: 30%;\n    display: none;\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    padding: 0;\n    margin: 0;\n}\n\n.task-header:hover .delete-task{\n    display: block;\n}\n\n.delete-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n\n#curr-project-title{\n    margin-top: 2rem;\n    margin-bottom: 20px;\n    font-size: 1.8rem;\n    padding-bottom: 0.25rem;\n\n    cursor: default;\n\n    -webkit-user-select: none; /* Safari */        \n    -moz-user-select: none; /* Firefox */\n    -ms-user-select: none; /* IE10+/Edge */\n    user-select: none; /* Standard */\n}\n\n.task-details, .task-title{\n    margin-left: 4px;\n}\n\n.task-details{\n    border: solid var(--task-header) 1px;\n    border-top: none;\n    border-radius: 0px 0px 3px 3px;\n\n    margin: 0;\n    padding: 0;\n    margin-right: 10%;\n\n    padding-left: 0.8rem;\n    padding-top: 0.4rem;\n    padding-bottom: 0.4rem;\n\n}\n\n.task-description, .task-priority{\nmargin: 0.65em;\n}\n.task-description{\n    font-style: italic;\n}\n\n.due-date{\n    align-self: center;\n    justify-self: right;\n    padding-right: 1rem;\n    font-size: 0.85rem;\n}\n\n.task-header{\n    background-color: var(--task-header);\n    margin: 0;\n    padding: 0;\n    border-radius: 3px;\n\n    display: grid;\n    grid-template-columns: 4% 70% 26%;\n    margin-right: 10%;\n\n    cursor: pointer;\n    border-left: solid transparent 4px;\n}\n\n.task-header:hover{\n    grid-template-columns: 4% 62% 26% 4% 4%;\n}\n\n.task-header:hover{\n    background-color: var(--task-header-hover);\n}\n\n.overdue{\n    color: red;\n}\n\n#add-task-header{\n    text-align: center;\n}\n\n.edit-task{\n    display: none;\n    align-self: center;\n    justify-self: center;\n    height: 1.8rem;\n    background-color: transparent;\n    border: none;\n}\n\n.task-header:hover .edit-task{\n    display: block;\n}\n\n.edit-task:hover{\n    background-color: var(--my-purple);\n    color: white;\n}\n\n.high{\n    border-left: red solid 4px;\n}\n\n.medium{\n    border-left: yellow solid 4px;\n}\n\n.low{\n    border-left: green solid 4px;\n}\n\n.task{\n    cursor: default;\n}\n\n\n.task-header .far{\n    justify-self: center;\n    align-self: center;\n}\n\n.hidden{\n    display: none;\n}\n\n.fa-check-circle.hidden .fa-circle{\n    color: red;\n}\n\n.crossed-out{\n    text-decoration: line-through;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
class DisplayTask {
    ...
    static updateCheckBox(checkedBool, task, unchecked, checked) {
        ...
        _storageManager_js__WEBPACK_IMPORTED_MODULE_2__.default.updateTask(projTitle, task.getTitle(), task)
    ...
    static displayDate(completed, dueDate) {
        ...
        try {
            formattedDate = `due ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(formattedDate, 'MM-dd-yyyy')}`
            formattedDate = `due ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(new Date(dueDate), {
                addSuffix: true,
            })}`
        } catch (error) {
            formattedDate = ''
    ...
    static errorCheck() {
        ...
        try {
            ...
            if (taskName.length < 1) {
                ...
                typeof _storageManager_js__WEBPACK_IMPORTED_MODULE_1__.default.getTask(projectTitle, taskName) === 'object'
            ) {
